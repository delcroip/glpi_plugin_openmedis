...
CREATE TABLE  `glpi_plugin_openmedis_devicemedicalaccessories` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT, -- AccessoryID
  `designation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL, -- former designation
  `comment` text COLLATE utf8mb4_unicode_ci,
  `manufacturers_id` int(11) unsigned NOT NULL DEFAULT '0',-- ManufacturerID
  `part_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
 -- `capacity` int(11) DEFAULT NULL,
  `plugin_openmedis_medicalaccessorytypes_id` int(11) unsigned NOT NULL DEFAULT '0',
  `entities_id` int(11) unsigned NOT NULL DEFAULT '0',
  `is_recursive` tinyint(1) NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevicecategories_id` int(11) unsigned DEFAULT NULL,
...
CREATE TABLE `glpi_plugin_openmedis_medicaldevicecategories` (
  ...
  `plugin_openmedis_medicaldevicecategories_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE  `glpi_plugin_openmedis_items_devicemedicalaccessories` (
  ...
  `plugin_openmedis_devicemedicalaccessories_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE  `glpi_plugin_openmedis_medicaldevices` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT, -- assetid
  `entities_id` int(11) unsigned NOT NULL DEFAULT '0',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL, -- AssetFullName
  `date_mod` timestamp NULL DEFAULT NULL,
  ...
  `locations_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevicemodels_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevicecategories_parent_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevicecategories_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_utilizations_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_openmedis_medicalconsumableitems_medicaldevicemodels` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `plugin_openmedis_medicalconsumableitems_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevicemodels_id` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `glpi_plugin_openmedis_medicalconsumables` (
  ...
  `entities_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicalconsumableitems_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicaldevices_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_openmedis_medicalconsumableitems` (
  ...
  `locations_id` int(11) unsigned NOT NULL DEFAULT '0',
  `plugin_openmedis_medicalconsumableitemtypes_id` int(11) unsigned NOT NULL DEFAULT '0',
  `manufacturers_id` int(11) unsigned NOT NULL DEFAULT '0',
  `users_id_tech` int(11) unsigned NOT NULL DEFAULT '0',
  `groups_id_tech` int(11) unsigned NOT NULL DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
