...
CREATE TABLE  `glpi_plugin_openmedis_medicaldevices` (
  ...
  `plugin_openmedis_medicaldevicecategory_id` int(11) NOT NULL DEFAULT '0',
  ...
  KEY `plugin_openmedis_medicaldevicecategory_id` (`plugin_openmedis_medicaldevicecategory_id`),
  KEY `is_deleted` (`is_deleted`),
  KEY `date_mod` (`date_mod`),
